			...
			<div className="grid h-full grid-cols-1 gap-0 md:grid-cols-2">
				<div className="flex h-full flex-col p-6">
					<p className="mb-4 text-sm leading-relaxed">
						This example demonstrates a product catalog with lightweight table
						filtering and pagination using TanStack Table.
					</p>

					<div className="mb-4">
						<h3 className="mb-2 font-semibold">Planned Features:</h3>
						<ul className="list-disc space-y-2 pl-5 text-sm">
							<li>Sortable and filterable product tables</li>
							<li>Pagination with customizable page sizes</li>
							<li>Column visibility toggling</li>
							<li>Responsive table design</li>
							<li>Row selection and batch actions</li>
						</ul>
					</div>
				</div>
